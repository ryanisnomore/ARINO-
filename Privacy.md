# ARINO Privacy Policy 
Last Updated: June 08 2025

This document outlines the privacy policy for the Discord bot This document outlines the privacy policy for the Discord bot ("ARINO") and its associated services provided by the developer. and its associated services provided by the developer.
...
## Data we collect includes:
 - **Premium Purchase Records:** When you buy ARINO Premium, we keep a record of the purchase (like transaction ID, price, premium slots) linked to your User ID. We don't store or gather your payment card information.
 - **Premium Slot Records:** When a user buys ARINO Premium, we save the guild IDs they activate and the number of slots connected to their User ID.
...
If you want your user data deleted, you can reach out to us by Join our [Support Discord server](https://dsc.gg/arino-hq) and messaging a developer with your Discord User ID. Keep in mind, deleting certain data might make some or all features of the Service unavailable. And if you ask to delete premium information, your servers might get deactivated without a refund. You can request data deletion once every 30 days.
